...
do
    ...
    then
        ...
        echo "$citizenId $firstName $lastName $countryName $age $virusName $isVaccinated $day-$month-$year" >>inputFile.txt   
    else 
        isVaccinated="NO"
        echo "$citizenId $firstName $lastName $countryName $age $virusName $isVaccinated" >>inputFile.txt
    fi
done